 ...
 */
final class Version20240319170124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if (!$schema->getTable('task')->hasColumn('author_id')) {
    ...
    public function down(Schema $schema): void
    {
        ...
        if ($schema->getTable('task')->hasColumn('author_id')) {
            ...
            $this->addSql('ALTER TABLE task DROP COLUMN author_id');
        }
    }
}